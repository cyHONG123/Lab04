...
public class Lab4 {
    ...
    public boolean insert( trie a, String b ) {
        ...
        String[] var =  b.split("");
        /*Below part is if-left and if-right statement for string split*/
        /*Using recursive insert method, putting the string down each level once, if met already
        * existed string, replace(actually put it to next level) that string and use the replacing string for further recursive statement
        * util met null trie*/
    ...
    public void trieToList( trie a) {
        /*Below part is for finding from smallest string to largest string, by recursive statement*/
        if(a.left!=null) {
    ...
    public String getlargest(trie a) {
        /*Below part is finding largest by this recursive method, which find right most string*/
        String largest = "null";
    ...
    public String getsmallest(trie a) {
        /*Below part is finding smallest by this recursive method, which find left most string*/
    ...
    public String search(trie a, String b) {
        /*Below part is searching string, by following step of 0 and 1, which 0 is left and 1 is right*/
        /*if met string, output to the answer, if no correct trie next, try another trie next*/
        int count = 0;
        String[] b1 = b.split("");
    ...
    public void getsize(trie a) {
        /*Below part is finding size, similar to triesToList method*/
        if(a.left!=null) {
            if(a.left.getString()!=null) {
                size++;
            }else{
    ...
    public int getheight(trie a) {
        /*Below part is get height, by recursive statement in both side*/
        if (a==null) {
            return 0;
        } else {
